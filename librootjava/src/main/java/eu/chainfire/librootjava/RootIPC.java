...
public class RootIPC {
	 ...
	 *
	 * @param packageName Package name of process to send Binder to. Use BuildConfig.APPLICATION_ID (double check you're importing
	 * 	the correct BuildConfig!) for convenience
	 * @param ipc Binder object to wrap and send out
	 * @param code User-value, should be unique per Binder
	 * @param connection_timeout_ms How long to wait for the other process to initiate the connection, -1 for default, 0 to wait
	 * 	forever (if blocking)
	 ...
	 */
	public RootIPC(String packageName, IBinder ipc, int code, int connection_timeout_ms, boolean blocking)
